...
const ProductDetails = async({params:{id}}:Props) => {
  ...
  if (!product) {
    // If we don't get any product, then we will navigate to the home page
      return {
        redirect: {
          destination: '/',
          permanent: false,
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="product-info">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[21px] text-black opacity-60 line-through ">{product.currency} {formatNumber(product.originalPrice)}</p>
          </div>

          <div className="flex flex-col gap-4">
            <div className="flex gap-3">
              <div className="product-stars">
                <Image src="/assets/icons/star.svg" alt="star" width={16} height={16}></Image>
